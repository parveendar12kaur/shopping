...
SuperagentHttpClient.prototype.execute = function (obj) {
  ...
  var retry = obj.retry || obj.operation && obj.operation.parent && obj.operation.parent.retry;
  ...
  if (obj.redirects !== undefined) {
    r.redirects(obj.redirects);
  }

  if (typeof obj.agent === "function") {
    r.agent(obj.agent(obj.url));
  }
  ...
  if (!obj.proxy && (protocolProxies['http:'] || protocolProxies['https:'])) {
    var parsedUrl = url.parse(obj.url, false);
    var protocol = parsedUrl.protocol || 'http:';
    obj.proxy = protocolProxies[protocol];
  }
