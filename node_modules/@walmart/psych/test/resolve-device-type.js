...
describe("resolve-device-type", function () {
  ...
  it("should be a function", function (done) {
    expect(Psych.resolveDeviceType).to.be.a.function();
    done();
  });

  it("should return default desktop status if no headers present", function (done) {
  	var deviceType = Psych.resolveDeviceType({});

   	expect(deviceType).to.equal(DEVICE_TYPE_DESKTOP);
    done();
  });

  it("should return mobile status from sample akamai header", function (done) {
    var deviceType = Psych.resolveDeviceType(sampleAkamaiHeader);
