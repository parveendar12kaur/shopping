...
describe("test csrf-jwt hapi plugin", () => {
        ...
        server.route([
          {
            ...
            handler: (request, reply) => {
              ...
              expect(request.app.jwtCookie).to.exist;
          ...
          },
          {
            ...
            handler: (request, reply) => {
              ...
              expect(request.app.jwtCookie).to.not.exist;
              return reply("");
            },
            config: {
              plugins: {
  ...
  it("should return success", () => {
    return server.inject({method: "get", url: "/1"}, (res) => {
      ...
      expect(res.headers["set-cookie"][0]).to.contain(`x-csrf-jwt=${res.request.app.jwtCookie}; Secure; HttpOnly;`);
      ...
      return server.inject({
        ...
        expect(res.statusCode).to.equal(200);
        expect(res.headers["x-csrf-jwt"]).to.equal(res.request.app.jwt);
        expect(res.headers["set-cookie"][0]).to.contain(`x-csrf-jwt=${res.request.app.jwtCookie}`);
  ...
  it("should return 401 for missing jwt", () => {
