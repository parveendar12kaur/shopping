...
const ossHapiPlugin = require("electrode-react-webapp/lib/hapi");
...
const indexPagePlugin = (server, options, next) => {
  ...
  return Promise.join(
    ...
    (stats, statsDll, cdnAssets, criticalCSS) => {
      ...
      ossHapiPlugin.registerRoutes(server, myOptions);
